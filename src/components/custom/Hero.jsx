...
const Hero = () => {
  return (
    <div className='flex flex-col items-center mx-16  md:mx-28 lg:mx-56 gap-6 md:gap-8 text-center mt-12 md:mt-16'>
      <h1 className='font-extrabold text-[36px] md:text-[40px] lg:text-[44px] '><span className='text-[#f56551]'>Discover Your Next Adventure with      AI:</span> Personalized Itineararies at Your Fingertrips</h1>
